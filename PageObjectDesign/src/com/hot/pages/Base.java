...
public class Base {
	...
	public void click(WebElement el) throws InterruptedException{
	...
	public boolean IsObjectExist(WebElement el) throws InterruptedException{
	...
	public boolean clickElementById(String id) throws InterruptedException
	{
		try {
	...
	public boolean clickElementByCss(String css) throws InterruptedException
	{
		try {
			//WebElement element = driver.findElement(By.id(id));
			WebElement element = (new WebDriverWait(driver, 10))
	...
	public boolean VerifyTextAppearInWL(WebElement el, String text) throws InterruptedException
	{
		...
		try {
			...
			{
				System.out.println("Text1111 in web element successfully found");
				return false;
			}
		} catch (org.openqa.selenium.NoSuchElementException e) {
			// TODO Auto-generated catch block
